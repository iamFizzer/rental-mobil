...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{asset('dashboard')}}/src/assets/images/logos/favicon.png" />
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <ul class="navbar-nav">
            <li class="nav-item d-block d-xl-none">
              <a class="nav-link sidebartoggler nav-icon-hover" id="headerCollapse" href="{{asset('dashboard')}}/srcvascript:void(0)">
          ...
          <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                ...
                <a class="nav-link nav-icon-hover" href="{{asset('dashboard')}}/srcvascript:void(0)" id="drop2" data-bs-toggle="dropdown"
                  aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    <a href="{{asset('dashboard')}}/srcvascript:void(0)" class="d-flex align-items-center gap-2 dropdown-item">
